...
use sip_core::config::{Credentials, RegistrationConfig};
use sip_core::metrics::SipMetrics;
use sip_core::SipVersion;
use sip_core::{CSeqNumber, Host, RegistrationError, StatusCode, TransportProtocol};
use sip_message::{
...
impl RegistrationManager {
    ...
    fn build_register_request(
        ...
        let via = sip_message::ViaHeader::new(TransportProtocol::Udp, via_host, Some(5060));
