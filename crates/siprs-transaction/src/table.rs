...
mod tests {
    ...
    use siprs_core::{Host, StatusCode, TransportProtocol};
    ...
    fn create_test_invite() -> siprs_message::SipRequest {
    ...
    fn create_test_response(status_code: u16, branch: &BranchId) -> siprs_message::SipResponse {
        let mut headers = HeaderCollection::new();
