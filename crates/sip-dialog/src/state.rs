...
use sip_core::{CSeqNumber, CallId, DialogError, Host, SipVersion, Tag, TransportProtocol};
use sip_message::{
...
pub fn build_in_dialog_request(
    ...
    headers.insert(
        HeaderName::CallId,
        HeaderValue::CallId(sip_message::CallId(dialog.id.call_id.clone())),
    );
...
mod tests {
    use super::*;
    use sip_core::StatusCode;
    use sip_message::ContactHeader;
