...
fn create_full_invite_request() -> SipMessage {
    ...
    headers.insert(
        HeaderName::From,
        HeaderValue::FromTo(siprs_message::headers::FromToHeader {
    ...
    headers.insert(
        HeaderName::Contact,
        HeaderValue::Contact(siprs_message::headers::ContactHeader {
            display_name: None,
