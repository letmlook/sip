...
//!
//! ```ignore
//! use siprs_ua::gb28181::{Gb28181Config, Gb28181Device};
//!
...
use siprs_sdp::gb28181::{build_ok_sdp, AudioEncoding, MediaParam, StreamType, VideoEncoding};
...
impl Gb28181Device {
    ...
    pub async fn handle_catalog_query(
        ...
        sn: u32,
        device_id: &str,
        items: Vec<siprs_gb28181_xml::DeviceItem>,
    ) -> Result<(), String> {
        ...
        let response = siprs_gb28181_xml::Response::catalog(sn, device_id_obj, sum_num, items);
    ...
    pub async fn handle_device_info_query(
        ...
        let mut response = siprs_gb28181_xml::Response::device_info(sn, device_id_obj);
        // DeviceInfo 响应通常包含一个设备项
        let mut item = siprs_gb28181_xml::DeviceItem::new(
            siprs_gb28181_codec::DeviceId::parse(device_id)
                .map_err(|e| format!("invalid device_id: {}", e))?,
        );
...
mod tests {
    ...
    fn test_gb28181_event_debug() {
        ...
        let event = Gb28181Event::InviteReceived {
            ...
            device_id: "34020000001320000001".to_string(),
            sdp: Box::new(siprs_sdp::types::SessionDescription {
                version: 0,
                origin: siprs_sdp::types::Origin {
                    username: "-".to_string(),
                    session_id: 0,
                    session_version: 0,
